...
export const TelegramImg = ({className}: { className?: string }) => {
    return (
        <SvgWrapper width='1.5vw' version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"
             className={className}>
            <path fill="#7c7c7c" d="M88.723,12.142C76.419,17.238,23.661,39.091,9.084,45.047c-9.776,3.815-4.053,7.392-4.053,7.392
