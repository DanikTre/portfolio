...
export const AboutImg = ({className}: { className?: string }) => {
    return (
        <SvgWrapper width='1.5vw' version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 489.8 489.8" className={className}>
            <path fill="#7c7c7c" d="M66.4,404.2c5,0,9.1-4.1,9.1-9.1v-50.4c0-8,3.5-15.5,9.6-20.5c44.9-36.9,93.5-61.4,102.8-66
